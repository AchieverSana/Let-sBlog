  ...
  return (
    <div className='flex flex-col sm:flex-row border border-teal-500 rounded-2xl overflow-hidden'>
      <div className='flex-1 flex flex-col gap-4 p-6 justify-center'>
        ...
        <a href='https://leetcode.com/u/Achieversana/' target='_blank' rel='noopener noreferrer'>
      ...
      <div className='flex-1 flex flex-col gap-4 p-6 justify-center'>
        ...
        <p className='text-gray-500 dark:text-gray-400'>
          Browse through my repositories and see what I have been building.
        </p>
        <a href='https://github.com/AcheiverSana' target='_blank' rel='noopener noreferrer'>
          <Button className='bg-gradient-to-r from-teal-400 to-cyan-500 border-0 w-full'>
            View my GitHub
          </Button>
        </a>
